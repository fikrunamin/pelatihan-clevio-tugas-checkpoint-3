            ...
            <div class="bg-white p-10">
                <div class="mb-10">
                    <h3 class="mb-2"><a href="{{route('dashboard.index')}}"
                                        class="border-b-2 border-color-1">Dashboard</a> / Berita</h3>
                    <h1 class="text-2xl font-semibold">Daftar Berita</h1>
                </div>
                <div class="grid grid-cols-1">
                    <div class="flex justify-end gap-x-5 mb-5">
                        <a href="{{route('berita.create')}}" class="flex items-center py-1 px-3 bg-color-1 text-color-4"><i
                                class="material-icons">add</i> Tambah Berita</a>
                    </div>
                    <div class="grid grid-cols-1">
                        <table id="table" class="text-center">
                            ...
                            @foreach($list_berita as $index => $berita)
                                <tr>
                                    <td>{{$index + 1}}</td>
                                    <td><img src="{{asset('images/' . $berita->sampul)}}"
